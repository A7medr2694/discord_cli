...
| Crosspost / bulk-delete | `CrosspostMessage{cid,mid}` (64), `BulkDeleteMessages{cid}` (74) | `User::crosspost_message` / `User::bulk_delete_messages` (validates 2..=100) | `ModelError::BulkDeleteAmount` for <2 |
